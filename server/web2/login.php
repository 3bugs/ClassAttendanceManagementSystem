    ...
    <div class="row" style="margin: 0">
        <div class="col-md-4">
            <form id="login_form" method="post" action="<?php echo $phpSelf; ?>">
                <div class="container" style="margin-right: 0; margin-top: 20px">
                    <div class="imgcontainer">
                        <img src="images/logo.png" alt="ตราสัญลักษณ์ มหาวิทยาลัยสวนดุสิต" class="logo">
                    </div>

                    <div id="success_div" class="alert alert-success alert-dismissible" role="alert"
                         style="display: none; ">
                    ...
                    <div style="padding-top: 10px;">
                        <h3>เข้าสู่ระบบบริหารการศึกษา</h3>
                    </div>

                    <label for="username"><b>ชื่อผู้ใช้งาน</b></label>
                    <input type="text" class="form-control" placeholder="กรอกชื่อผู้ใช้" id="username_input"
                           name="username"
                           style="font-family: monospace;" required>

                    <label for="password"><b>รหัสผ่าน</b></label>
                    <input type="password" class="form-control" placeholder="กรอกรหัสผ่าน" id="password_input"
                           name="password"
                           style="font-family: monospace;" required>

                    <button type="submit" id="login_button" name="login" style="margin-top: 20px;">ลงชื่อเข้าใช้</button>

                    <div style="text-align: center; margin: 10px">
                        จำนวนผู้ใช้งานระบบปัจจุบัน
                    </div>
                    <div style="text-align: center; margin: 10px">
                        ตารางเรียน/ตารางสอบ
                    </div>
        ...
        <div class="col-md-8" style="height: 100%">
            <div class="container" style="height: 100%; margin-left: 0; margin-top: 20px">
                <h3>แจ้งข่าวสาร / ประชาสัมพันธ์</h3>
                <ol>
